const social = [
	{
		name: "Facebook",
		href: "#", // TODO: remplacer par lien Facebook
	...
	{
		name: "Instagram",
		href: "#", // TODO: remplacer par lien Instagram
		icon: (props: React.SVGProps<SVGSVGElement>) => (
			<svg fill="currentColor" viewBox="0 0 24 24" {...props}>
				<path
					fillRule="evenodd"
	...
	return (
		<footer className="border-t border-black/5 dark:border-white/10">
			<div className="mx-auto max-w-7xl px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
				...
				{/* Copyright */}
				<p className="mt-8 text-center text-sm/6 text-subtle md:order-1 md:mt-0">
					&copy; {new Date().getFullYear()} ZenCare. Todos los derechos
					reservados.
				</p>
			</div>
		</footer>
